...
# Small update by Andy Exley:
#  * added getMouseWithButton method that returns mouse click location and
#     mouse button number as tuple
#
...
class GraphWin(tk.Canvas):
    ...
    def getMouseWithButton(self):
        ...
        self.mouseX = None
        self.mouseY = None
        return Point(x,y), self.mouseNum
